...
<!-- Mirrored from freshcart.codescandy.com/pages/store-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Mar 2023 23:51:04 GMT -->
<head>
    ...
    <div class="container px-0 px-md-3">
      <div class="dropdown me-3 d-none d-lg-block">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            <li><a class="dropdown-item" href="{{ route('shop_grid') }}">Dairy, Bread & Eggs</a></li>
            <li><a class="dropdown-item" href="{{ route('Snacks_Munchies') }}">Snacks & Munchies</a></li>
            <li><a class="dropdown-item" href="{{ Route('Fruits_Vegetables') }}">Fruits & Vegetables</a></li>
            <li><a class="dropdown-item" href="{{ Route('Cold_Drink') }}">Cold Drinks & Juices</a></li>
            <li><a class="dropdown-item" href="{{ Route('Breakfast_Food') }}">Breakfast & Instant Food</a></li>
            <li><a class="dropdown-item" href="{{ Route('Bakery_Biscuits') }}">Bakery & Biscuits</a></li>
            <li><a class="dropdown-item" href="{{ Route('Meat_Fish') }}">Chicken, Meat & Fish</a></li>
        </ul>
      </div>
...
<!-- Mirrored from freshcart.codescandy.com/pages/store-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Mar 2023 23:51:07 GMT -->
</html>
