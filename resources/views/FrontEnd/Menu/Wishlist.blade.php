              ...
              <table class="table text-nowrap table-with-checkbox">
                ...
                <tbody>
                 ...
                 <tr>
                  ...
                  <td class="align-middle">
                    <a href="#"><img src="{{asset("$Wihs->proPhoto")}}"
                        class="icon-shape icon-xxl" alt=""></a>

                  </td>
                  <td class="align-middle">
                    <div>
                      <h5 class="fs-6 mb-0"><a href="#" class="text-inherit">{{ $Wihs->Name}}</a></h5>
                      <small>{{ $Wihs->weight }}</small>
                    </div>
                  </td>
                  <td class="align-middle">{{ $Wihs->Sale_price }}</td>
                  @if ($Wihs->Instock==0)
                  ...
                  @endif
                  <td class="align-middle">
                    <a href="{{ url('Addtocart/'.$data->id.'/'.$Wihs->id) }}"><div class="btn btn-primary btn-sm">Add to Cart</div></a>
                  </td>
                  <td class="align-middle "><a href=" {{url('wishlistdelete/'.$data->id.'/'.$Wihs->id) }}" class="text-muted" data-bs-toggle="tooltip"
