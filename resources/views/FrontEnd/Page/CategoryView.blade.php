        ...
        <aside class="col-lg-3 col-md-4 mb-6 mb-md-0">
          <div class="offcanvas offcanvas-start offcanvas-collapse w-md-50 " tabindex="-1" id="offcanvasCategory" aria-labelledby="offcanvasCategoryLabel">
            ...
            <ul class="nav nav-category" id="categoryCollapseMenu">
             @foreach ($datac as $categories)
             <li class="nav-item border-bottom w-100 collapsed"><a href="{{ route('CategoryView',$categories->idcat) }}"
               class="nav-link">{{ $categories->CategoryName }} </a>
           </li>
             @endforeach
        ...
        <section class="col-lg-9 col-md-12">
          ...
          <div class="card mb-4 bg-light border-0">
            ...
            <div class=" card-body p-9">
              <h2 class="mb-0 fs-1">{{ $cat->CategoryName }}</h2>
            </div>
          </div>
          <!-- list icon -->
          <div class="d-lg-flex justify-content-between align-items-center">
            <div class="mb-3 mb-lg-0">
              <p class="mb-0"> <span class="text-dark">{{ $cat->NumberOfProducts }} </span> Products found </p>
            </div>
           ...
           @foreach ($prod as $produits)
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ Route('productview',$produits->id)}}">
                            <!-- img --><img src="{{ asset("$produits->proPhoto") }}"
                            alt="Grocery Ecommerce Template" 
                            height="164px"
                            width="160px"></a>
                        <!-- action btn -->
                        <div class="card-product-action">
                            <a href="#!" class="btn-action" data-bs-toggle="modal" data-bs-target="#quickViewModal{{ $produits->id }}"><i
                                class="bi bi-eye" data-bs-toggle="tooltip" data-bs-html="true" title="Quick View"></i></a>
                            <a href="{{ url('wishlist/'.$data->id.'/'.$produits->id) }}" class="btn-action" data-bs-toggle="tooltip" data-bs-html="true"
                        ...
                        <!-- heading -->
                        <div class="text-small mb-1"><a href="#!" class="text-decoration-none text-muted"><small>{{ $cat->CategoryName }}</small></a></div>
                        <h2 class="fs-6"><a href="shop-single.html" class="text-inherit text-decoration-none">{{ $produits->Name }}</a></h2>
                        <div>
                        <!-- rating -->
                        ...
                        <div><span class="text-dark">${{ $produits->Sale_price }}</span> <span
                            class="text-decoration-line-through text-muted">${{ $produits->Regular_price }}</span>
                        </div>
                        <!-- btn -->
                          ...
                          <div class="row">
                              ...
                              <!-- img slide -->
                                  <div class="product productModal" id="productModal">
                                      ...
                                      <!-- img -->
                                          <img
                                              src="{{ asset("$product->proPhoto") }}" alt="">
                                      </div>
                                  <div>
