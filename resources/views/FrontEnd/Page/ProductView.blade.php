...
<!-- Mirrored from freshcart.codescandy.com/pages/shop-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Mar 2023 23:50:52 GMT -->
<head>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="product" id="product">
            <div
              style="background-image: url({{ asset("$prod->proPhoto") }})">
              <!-- img -->
              <!-- img --><img src="{{ asset("$prod->proPhoto") }}" alt="">
            </div>
            <div>
              <div
            ...
            <div class="thumbnails row g-3" id="productThumbnails">
              <div class="col-3">
                <div class="thumbnails-img">
                  <!-- img -->
                  <img src="{{ asset("$prod->proPhoto") }}" alt="">
                </div>
              </div>
        ...
        <div class="col-md-6">
          <div class="ps-lg-10 mt-6 mt-md-0">
            <!-- content -->
            <a href="#!" class="mb-4 d-block">{{ $cat->CategoryName }}</a>
            <!-- heading -->
            <h1 class="mb-1">{{ $prod->Name }}</h1>
            <div class="mb-4">
              <!-- rating -->
              <!-- rating -->
            ...
            <div class="fs-4">
              <!-- price --><span class="fw-bold text-dark">{{ $prod->Sale_price }}</span> <span
                class="text-decoration-line-through text-muted">{{ $prod->Regular_price }}</span><span><small class="fs-6 ms-2 text-danger">26%
                  Off</small></span>
            </div>
            <!-- hr -->
            <hr class="my-6">
            <div class="mb-5"><button type="button" class="btn btn-outline-secondary">250g</button>
              ...
              <div>
                ...
                <div class="input-group input-spinner  ">
                  ...
                  <input type="number" step="1" max="10" name="quantity" class="quantity-field form-control-sm form-input   ">
            ...
            <div class="mt-3 row justify-content-start g-2 align-items-center">
              ...
              <div class="col-xxl-4 col-lg-4 col-md-5 col-5 d-grid">
                <!-- button -->
                <!-- btn --> <a href="{{ url('Addtocart/'.$data->id.'/'.$prod->id) }}"><button type="button" class="btn btn-primary"><i class="feather-icon icon-shopping-bag me-2"></i>Add to cart</button></a>
              </div>
            ...
            <div class="tab-pane fade show active" id="product-tab-pane" role="tabpanel" aria-labelledby="product-tab"
              ...
              <div class="my-8">
                ...
                <div class="mb-5">
                  ...
                  <p class="mb-0">{{ $prod->Utnits }}</p>
                </div>
                <div class="mb-5">
                  <h5 class="mb-1">Seller</h5>
                  <p class="mb-0">{{ $sel->Nom }}</p>
                </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-8">
                      <div class="mb-10">
                        ...
                        <form action="{{ url('add-rating/'.$prod->id.'/'.$data->id) }}" method="POST">
                            @csrf
                                    <div>
                                        <!-- rating -->
                                        ...
                                        <input type="text" name="headline" class="form-control" placeholder="What’s most important to know">
                                        </div>
                                        <div class="border-bottom py-4 mb-4">
                                        ...
                                        <textarea class="form-control" rows="3" name="Writen_review"
        ...
        @foreach ($datap as $product)
                <div class="col">
                    ...
                    <div class="card-body">
                        ...
                        <a href="{{ Route('productview',$product->id) }}"> <img src="{{ asset("$product->proPhoto") }}" alt="Grocery Ecommerce Template" height="164px"
                            width="160px"></a>
          ...
          <div class="col-lg-6">
            ...
            <div class="product productModal" id="productModal">
              <div
                ...
                style="
                  background-image: url({{ $prod->proPhoto }});
                "
              >
                <!-- img -->
                <img
...
<!-- Theme JS -->
  ...
  <script src="j{{ asset("s/vendors/increment-value.js") }}"></script>
