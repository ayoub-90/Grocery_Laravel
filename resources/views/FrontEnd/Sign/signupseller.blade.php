...
<!-- Mirrored from freshcart.codescandy.com/pages/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Mar 2023 23:54:21 GMT -->
<head>
    ...
    <div class="container">
      ...
      <div class="row justify-content-center align-items-center">
        ...
        <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
          ...
          <!-- form -->
          <form action="{{ Route('signupseller') }}" method="POST" enctype="multipart/form-data">
            {!!  csrf_field() !!}
            <div class="row g-3">
              <!-- col -->
              <div class="col-12">
                <!-- input --><input type="text" class="form-control" name="Nom" id="Nom" placeholder="First name" aria-label="First name"
                  required>
              </div>
              <div class="col-12">
                <!-- input --><input type="text" class="form-control" name="Username" id="Username" placeholder="User name" aria-label="Last name"
                  required>
              </div>

              <div class="col-12">
                <!-- input --><input type="text" class="form-control" name="NomMagasin" id="NomMagasin" placeholder="Magasin name" aria-label="Magasin name"
                  required>
                  <!-- input --><input type="hidden" class="form-control" name="TypeCompte" id="TypeCompte" value="2"
                  required>
              </div>

              <div class="col-12">
                <!-- input --><input type="text" class="form-control" name="Adresse" id="Adresse" placeholder="Adresse" aria-label="Adresse"
                  required>
              </div>

              <div class="col-12">
                <!-- input --><input type="text" class="form-control" name="Telephone" id="Telephone" placeholder="Telephone" aria-label="Telephone"
                  required>
              </div>
              <div class="col-12">
                 <!-- input --><input type="file" class="form-control" name="Photo" id="Photo" placeholder="Photo" aria-label="Photo"
                 required>
              </div>
              <div class="col-12">

                <!-- input --><input type="email" class="form-control" name="Email" id="inputEmail4" placeholder="Email" required>
              </div>
...
<!-- Mirrored from freshcart.codescandy.com/pages/signup.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Mar 2023 23:54:24 GMT -->
</html>
