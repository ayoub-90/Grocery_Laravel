  ...
  <section class="mb-lg-14 mb-8 mt-8">
    <div class="container">
      ...
      <div>
        <!-- row -->
        <div class="row">
         <form class="col-lg-7 col-md-12" action="{{url('placeorder/'.$data->id)}}" method="POST">
          {{ csrf_field() }}
            <!-- accordion -->
                      ...
                      <div class="col-lg-6 col-12 mb-4">
                        ...
                        @foreach ($address as $item)
                            <div class="card card-body p-6 ">
                              ...
                              <!-- address -->
                              <address> <strong>{{$item->City}}</strong> <br>

                                {{$item->Adress1}} <br>

                               {{$item->Adress2}}<br>

                                <abbr title="Phone">{{$item->Zipecode}}</abbr></address>
                                @if ($item->defadrr==1)
              ...
              <div class="accordion-item py-4">
                ...
                <div id="flush-collapseThree" class="accordion-collapse collapse "
                  ...
                  <div class="mt-5">
                    ...
                    <textarea class="form-control" name="instructions" id="DeliveryInstructions" rows="3"
                  ...
                  <div class="mt-5">
                    <div>
                            ...
                            <div class="d-flex">
                              <div class="form-check">
                                ...
                                <label class="form-check-label ms-2" for="paypal">
                                  <input type="hidden" name="paymod" value="{{$item->id}}">

                                </label>
                              </div>
                              <div>
                                <!-- title -->
                                <h5 class="mb-1 h6"> <img src="{{$item->Payement}}" alt=""> *****{{substr($item->Cardnumber,-5)}}</h5>
                                <p class="mb-0 small">{{$item->Nameoncard}}  {{$item->Month}}/{{$item->Year}}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="card-body p-6">
                          ...
                          <div class="d-flex">
                            <div class="form-check">
                              ...
                              <label class="form-check-label ms-2" name="paymod" for="cashonDelivery">
                      ...
                      <div class="mt-5 d-flex justify-content-end">
                        ...
                        <button href="" class="btn btn-primary ms-2">Place Order</button>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="col-12 col-md-12 offset-lg-1 col-lg-4">
            <div class="mt-4 mt-lg-0">
              <div class="card shadow-sm">
                ...
                <ul class="list-group list-group-flush">
                  <!-- list group item -->
                  <form action="{{url('placeorder/'.$data->id)}}" method="POST">
                    {{ csrf_field() }}
                      @foreach($datacart as $item)
                        <li class="list-group-item px-4 py-3">
                          <div class="row align-items-center">
                            <div class="col-2 col-md-2">
                              <img src="{{$item->proPhoto}}" alt="Ecommerce" class="img-fluid"></div>
                              <input type="hidden" name="produit" value="{{$item->id}}">
                            <div class="col-5 col-md-5">
                              <h6 class="mb-0">{{$item->Name}}</h6>
                              <span><small class="text-muted">{{$item->Utnits}}</small></span>
                            ...
                            <div class="col-3 text-lg-end text-start text-md-end col-md-3">
                              <span class="fw-bold">{{$item->Sale_price}}</span>
                  ...
                  <li class="list-group-item px-4 py-3">
                    ...
                    <div class="d-flex align-items-center justify-content-between  ">
                      ...
                      <div class="fw-bold">$<span id="fee">3</span></div>
                  ...
                  <li class="list-group-item px-4 py-3">
                    <div class="d-flex align-items-center justify-content-between fw-bold">
                      ...
                      <div>$<span class="fw-bold" id="total"></span></div>
                      <input type="hidden" id="totali" name="prix" value="">
                    </div>
...
document.addEventListener("DOMContentLoaded", function() {
  var calculateButton = document.getElementById("calculateButton");
    ...
    var prix = parseFloat(document.getElementById("prix").innerText);
    var fee = parseFloat(document.getElementById("fee").innerText);
    var total = prix + fee;
    document.getElementById("total").innerText = total.toFixed(2); // Display total with 2 decimal places
