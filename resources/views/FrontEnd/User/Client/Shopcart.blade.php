          ...
          <div class="row align-items-center">
            ...
            <div class="col-3 col-md-3 col-lg-3">
              ...
              <div class="input-group input-spinner  ">
                <button type="button" id="decrementButton" value="-" class="button-minus  btn  btn-sm " data-field="quantity">
                <input type="number" step="1" max="10" value="1" id="quantity" name="quantity"
                  class="quantity-field form-control-sm form-input   ">
                <button type="button" value="+" id="incrementButton" class="button-plus btn btn-sm " data-field="quantity">
              </div>
              ...
              <li class="list-group-item py-3 py-lg-0 px-0 border-top">
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-4 col-md-5">
                    <!-- title -->
                    <a href="shop-single.html" class="text-inherit"><h6 class="mb-0">{{ $car->Name }}</h6></a>
                    <span><small class="text-muted">{{ $car->weight }}</small></span>
                    <!-- text -->
                    <div class="mt-2 small lh-1"> <a href="{{ url('DeleteFromCart/'.$car->id) }}" class="text-decoration-none text-inherit"> <span
                          class="me-1 align-text-bottom">
          ...
          <div class="mb-5 card mt-6">
            <div class="card-body p-6">
              ...
              <div class="d-grid mb-1 mt-4">
                <!-- btn -->
                <a href="{{Route('checkout')}}"><button class="btn btn-primary btn-lg d-flex justify-content-between align-items-center" type="submit">
                  Go to Checkout <span class="fw-bold">$<span id ="goto"></span></span></button></a>
              </div>
              <!-- text -->
...
document.addEventListener("DOMContentLoaded", function() {
  var calculateButton = document.getElementById("calculateButton");
    ...
    document.getElementById("goto").innerText = total.toFixed(2); 
});
