...
<!-- Mirrored from freshcart.codescandy.com/pages/shop-filter.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 24 Mar 2023 23:50:52 GMT -->
<head>
    ...
    <div class="container">
      ...
      <div class="row gx-10">
        <div class="col-12">
          ...
          <!-- collapse -->
          <div class="collapse mt-6 hide" id="collapseFilter">
        ...
        <div class="col-12 mt-10">
          ...
          <div class="d-md-flex justify-content-between align-items-center">
            <div>
              <p class="mb-3 mb-md-0"> <span class="text-dark"> {{ $searchproduct->count() }}</span> Products found </p>
            </div>
            <!-- list -->
          ...
          <div class="row g-4 row-cols-xl-5 row-cols-lg-3 row-cols-2 row-cols-md-2 mt-2">
            @if ($searchproduct && count($searchproduct) > 0)
                        ...
                        <div class="card card-product">
                          <div class="card-body">
                            ...
                            @endif
                              ...
                              <a href="{{ Route('productview',$result->id) }}">
                                <!-- img -->
                                <img src="{{ $result->proPhoto }}" alt="Grocery Ecommerce Template"
                            ...
                            <h2 class="fs-6"><a href="shop-single.html" class="text-inherit text-decoration-none">{{ $result->Name }}</a></h2>

                            <!-- price -->
                            <div class="d-flex justify-content-between align-items-center mt-3">
                              <div><span class="text-dark">{{ $result->Sale_price }}</span> <span
                                  class="text-decoration-line-through text-muted">{{ $result->Regular_price }}</span>
                              </div>
                              <!-- btn -->
