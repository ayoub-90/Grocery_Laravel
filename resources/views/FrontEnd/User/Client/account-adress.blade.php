...
@foreach ($address as $adr)
    <div class="modal fade" id= "editAddressModal{{ $adr->id }}" tabindex="-1" aria-labelledby="addAddressModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
        <!-- modal content -->
        <div class="modal-content">
            <!-- modal body -->
            ...
            <!-- row -->
            <form action="{{ Route('updateaddress',$adr->id) }}" method="POST">
                {!! csrf_field() !!}
                <div class="row g-3">
                    <div class="col-12">
                        <!-- input -->
                    <input type="text" class="form-control" name="type" value="{{ $adr->type }}"  placeholder="Place">
                    </div>
                    <!-- col -->

                    <div class="col-12">
                        <!-- input -->
                    <input type="text" class="form-control" name="Adress1" value="{{ $adr->Adress1 }}"  placeholder="Address Line 1">
                    </div>
                    <!-- col -->
                    <div class="col-12">
                        <!-- input -->
                    <input type="text" class="form-control" name="Adress2" value="{{ $adr->Adress2 }}" placeholder="Address Line 2">
                    </div>
                    <!-- col -->
                    <div class="col-12">
                    <!-- input -->
                    <input type="text" class="form-control" name="City" value="{{ $adr->City }}" placeholder="City">
                    </div>
                    <!-- col -->
                    <div class="col-12">
                    <!-- input -->
                    <input type="text" class="form-control" name="Zipecode" value="{{ $adr->Zipecode }}" placeholder="Zipe Code">
                    </div>
                    <!-- col -->
                    <div class="col-12">
                    <!-- form check -->
                    <div class="form-check">
                        @if ( $adr->defadrr==1 )
                            <input class="form-check-input" type="checkbox" name="defadrr" value="" id="flexCheckDefault" checked>
                            <label class="form-check-label" for="flexCheckDefault">
                            Set as Default
                            </label>
                        @else
                            <input class="form-check-input" type="checkbox" name="defadrr" value="" id="flexCheckDefault">
                            <label class="form-check-label" for="flexCheckDefault">
                            Set as Default
                            </label>
                        @endif
...
<!-- section -->
        ...
        <div class="col-lg-3 col-md-4 col-12 border-end  d-none d-md-block">
          <div class="pt-10 pe-lg-10">
            ...
            <div class="profilepic">
                ...
                <a href=""><div class="profilepic__content">
            ...
            <ul class="nav flex-column nav-pills nav-pills-dark">
              ...
              <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link active" href="{{ Route('userAdress') }}"><i
                    class="feather-icon icon-map-pin me-2"></i>Address</a>
              </li>
              <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link" href="{{ Route('payementmethod') }}"><i
                   ...
                   @foreach ($address as $adr )
                        <div class="col-lg-5 col-xxl-4 col-12 mb-4">
                            ...
                            <p class="mb-6">Maroc<br>
                                ...
                                <!-- btn -->
                                @if ($adr->defadrr==1)
                                    <a href="#" name="defadrr" class="btn btn-info btn-sm">Default address</a>
                                @else

                                @endif

                            <div class="mt-4">
                                <a href="#" class="text-inherit" data-bs-toggle="modal" data-bs-target="#editaddressModal{{ $adr->id }}">Edit </a>
                                <a href="#" class="text-danger ms-3" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $adr->id }}">Delete
                                </a>
                                </div>
                            </div>
                            </div>
  ...
  <!-- Modal -->
  @foreach ($address as $adr)
    <form action="{{ Route('delAdress',$adr->id) }}" method="GET">
        {!! csrf_field() !!}
        <div class="modal fade" id="deleteModal{{ $adr->id }}" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
    ...
    <div class="modal-dialog modal-dialog-centered">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body p-6">
          ...
          <!-- row -->
          <form action="{{ Route('addadress',$data->id) }}" method="POST">
            {!! csrf_field() !!}
            <div class="row g-3">
                <div class="col-12">
                    <!-- input -->
                <input type="text" class="form-control" name="type" placeholder="Place">
                </div>
                <!-- col -->

                <div class="col-12">
                    <!-- input -->
                <input type="text" class="form-control" name="Adress1" placeholder="Address Line 1">
                </div>
                <!-- col -->
                <div class="col-12">
                    <!-- input -->
                <input type="text" class="form-control" name="Adress2" placeholder="Address Line 2">
                </div>
                <!-- col -->
                <div class="col-12">
                <!-- input -->
                ...
                <div class="col-12">
                <!-- input -->
                <input type="text" class="form-control" name="Zipecode" placeholder="Zipe Code">
                </div>
                <!-- col -->
                <div class="col-12">
                <!-- form check -->
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="defadrr" value="1" id="flexCheckDefault">
                    <label class="form-check-label" for="flexCheckDefault">
                    Set as Default
                    </label>
                </div>
