      ...
      <div class="row">
        ...
        <!--Pic-->
            ...
            <ul class="nav flex-column nav-pills nav-pills-dark">
              <!-- nav item -->
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="{{ Route('userorders') }}"><i
    ...
    <div class="offcanvas-body">
      <ul class="nav flex-column nav-pills nav-pills-dark">
        ...
        <li class="nav-item">
          ...
          <!-- nav item -->
        <li class="nav-item">
          <a class="nav-link " href="{{ Route('Accountset') }}"><i class="feather-icon icon-settings me-2"></i>Settings</a>
        </li>
          <!-- nav item -->
        <li class="nav-item">
