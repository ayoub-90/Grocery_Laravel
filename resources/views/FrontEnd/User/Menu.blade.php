      ...
      <div class="container">
        <div class="row w-100 align-items-center gx-lg-2 gx-0">
          <div class="col-xxl-2 col-lg-3">
            <a class="navbar-brand d-none d-lg-block" href="{{ Route('Userhome') }}">
              <img src="images/logo/logo.svg" alt="Hanooty">
          ...
          <div class="col-xxl-6 col-lg-5 d-none d-lg-block">
            ...
            <form action="{{ Route('prodsearch') }}" method="GET">
              <div class="input-group ">
                <input class="form-control rounded" type="search" name="search" value="" placeholder="Search for products">
          ...
          <div class="col-md-2 col-xxl-1 text-end d-none d-lg-block">
            ...
            <div class="list-inline">
              ...
              <div class="list-inline-item">
                ...
                <a href="#!" class="text-muted" data-bs-toggle="modal" data-bs-target="#userModal">
                    <a href="@yield('url')"><img src="@yield('src')" alt="" width="20" height="20" viewBox="0 0 24 24"></a>

                </a></div>
              <div class="list-inline-item">

                <a class="text-muted position-relative " data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight"
                  href="{{ Route('Cart') }}" role="button" aria-controls="offcanvasRight">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="feather feather-shopping-bag">
                    <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path>
    ...
    <div class="container px-0 px-md-3">
      <div class="dropdown me-3 d-none d-lg-block">
        ...
        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            @yield('alldepartement')
        </ul>
      </div>
      <div class="offcanvas offcanvas-start p-4 p-lg-0" id="navbar-default">
        <div class="d-flex justify-content-between align-items-center mb-2 d-block d-lg-none">
          <a href="index-2.html"><img src="images/logo/freshcart-logo.svg"
          ...
          <div class="collapse mt-2" id="collapseExample">
            <div class="card card-body">
              <ul class="mb-0 list-unstyled">
                <li><a class="dropdown-item" href="{{ url('shop_grid') }}">Dairy, Bread & Eggs</a></li>
        ...
        <div class="d-none d-lg-block">
          <ul class="navbar-nav align-items-center ">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link" href="{{ Route('Store_list') }}">
                Stores
              </a>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="{{ Route('forgotpassword') }}">Forgot Password</a></li>
                <li class="dropdown-submenu dropend">
                  <a class="dropdown-item dropdown-list-group-item dropdown-toggle" href="#">
                    My Account
                  </a>
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="{{ Route('userorders') }}">Orders</a></li>
                    <li><a class="dropdown-item" href="{{ Route('Accountset') }}">Settings</a></li>
                    <li><a class="dropdown-item" href="{{ Route('userAdress') }}">Address</a></li>
                    <li><a class="dropdown-item" href="{{ Route('payementmethod') }}">Payment Method</a>
                    </li>
                    <li><a class="dropdown-item" href="{{ Route('notifications') }}">Notification</a></li>
                  </ul>
                </li>
              </ul>
            </li>
