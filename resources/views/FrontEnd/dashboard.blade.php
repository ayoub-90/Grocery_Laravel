                ...
                <div class="navbar-vertical">
                                ...
                                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                                    <ul class="navbar-nav flex-column" id="sideNavbar">
                                        ...
                                        <li class="nav-item ">
                                            <a class="nav-link  active " href="{{ route('dashhome') }}" >
                            ...
                            <div class="col-lg-4 col-12 mb-6">
                                ...
                                <div class="card h-100 card-lg">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <!-- project number -->
                                        <div class="lh-1">
                                            <h1 class=" mb-2 fw-bold fs-2">${{ $comptes->total_prix }}</h1>
                                ...
                                <div class="card h-100 card-lg">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <div class="lh-1">
                                            ...
                                            <span><span class="text-dark me-1"></span>New Sales</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-12 mb-6">
                                ...
                                <div class="card h-100 card-lg">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <!-- project number -->
                                        <div class="lh-1">
                                            <h1 class=" mb-2 fw-bold fs-2">{{ $clients->count() }}</h1>
                                            <span><span class="text-dark me-1"></span>new in 2 days</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-centered table-borderless text-nowrap table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="#!"> <img src="{{ $item->proPhoto }}" alt=""
